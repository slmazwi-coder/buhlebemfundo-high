...
const bestEverStudents = [
  { name: "Top Achiever 1", title: "National Top Achiever", year: "2018", image: "", desc: "Achieved excellence in Mathematics and Physical Sciences" },
  { name: "Top Achiever 2", title: "Provincial Number 1", year: "2021", image: "", desc: "7 Distinctions, top student in Province" },
  { name: "Top Achiever 3", title: "Top Achiever in Commerce", year: "2019", image: "", desc: "Excellence in Accounting and Economics" },
  { name: "Top Achiever 4", title: "Overall Distinction", year: "2022", image: "", desc: "8 Distinctions with 95% average" },
  { name: "Top Achiever 5", title: "Provincial Top 5", year: "2016", image: "", desc: "Exceptional performance in Sciences" },
];
        ...
        <section className="mb-32">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Celebrating our 5 best ever students recorded who have left an indelible mark on BUHLEBEMFUNDO SECONDARY SCHOOL history.
            </p>
          </div>
