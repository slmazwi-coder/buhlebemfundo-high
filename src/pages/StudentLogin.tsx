...
export const StudentLogin = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    sessionStorage.setItem('buhlebemfundo_student_portal_student_number', sn);
    navigate('/student');
  };
    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      <div className="bg-gray-800 rounded-2xl shadow-2xl p-8 w-full max-w-md border border-gray-700">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm mt-1">Buhlebemfundo</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#1E40AF] focus:border-transparent"
          ...
          <button
            type="submit"
            className="w-full bg-[#1E40AF] text-white py-3 rounded-xl font-bold hover:bg-[#1e3a8a] transition-colors"
          >
            Sign In
          </button>
        </form>
