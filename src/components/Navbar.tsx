...
export const Navbar = () => {
  ...
  return (
    <nav className="w-full sticky top-0 z-50" style={{ background: '#1E40AF', borderBottom: '3px solid #1e3a8a' }}>

      {/* Top bar: Logo + School name + Student Portal */}
      <div className="w-full" style={{ borderBottom: '1px solid rgba(255,255,255,0.15)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">

            {/* Logo + Name */}
            <Link to="/" className="flex items-center gap-3 min-w-0 flex-1">
              <div className="h-11 w-11 shrink-0 rounded-xl bg-white flex items-center justify-center overflow-hidden shadow-md" style={{ border: '2px solid rgba(255,255,255,0.4)' }}>
                <img
                  src="/Logo/Badge.jpg"
                  alt="Buhlebemfundo logo"
              ...
              <Link
                ...
                className={cn(
                  ...
                  location.pathname.startsWith('/student')
                    ? 'text-school-primary bg-white'
                    : 'text-white border-2 border-white/60 hover:bg-white hover:text-school-primary'
                )}
              >
      ...
      <div className="hidden md:block w-full" style={{ background: '#1E40AF' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <Link
                ...
                style={
                  location.pathname === link.path
                    ? { color: '#1E40AF', background: 'white', fontWeight: 700 }
      ...
      {/* Mobile dropdown */}
      {isOpen && (
        <div className="md:hidden shadow-lg" style={{ background: '#1E40AF', borderTop: '1px solid rgba(255,255,255,0.15)' }}>
